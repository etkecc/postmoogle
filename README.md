...
* **POSTMOOGLE_TOKEN** - is alternative to password and shared secret. A pre-created access token: skips /login. E2EE needs a fresh device; crypto DB must persist paired to it.
